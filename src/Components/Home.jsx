          ...
          <div className="col-md-7 bg-light rounded-4">
            <div className="text-center p-5">
              <h1 className="text-main fw-bolder">
                {/* Password <span style={{color:"#4284f1"}}>R</span><span style={{color:"#DB4437"}}>e</span><span style={{color:"#737373"}}>s</span><span style={{color:"#F4B400"}}>e</span><span style={{color:"#0F9D58"}}>t</span> Application! */}Password Reset Application
              </h1>
